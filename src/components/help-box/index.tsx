...
export const HelpBox: React.FC = () => {
  ...
  const applicationName = 'radical-football73';
...
4. As a Coach, I want to be able to view and manage my team's schedule, so I can plan practices, games, and other events accordingly.
...
3. As a Player, I want to be able to communicate with my coach and teammates, so I can ask questions, receive feedback, and stay connected with my team.
...
2. As a Parent, I want to be able to communicate with my child's coach, so I can ask questions, provide feedback, and stay informed about my child's progress.
