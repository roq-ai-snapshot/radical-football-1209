          ...
          <>
            ...
            <>
              ...
              <Text fontSize="md" as="span">
                <Link as={NextLink} href={`/teams/view/${data?.coach?.[0]?.team?.id}`}>
                  {data?.coach?.[0]?.team?.name}
                </Link>
              </Text>
              <br />
            </>
            <>
              ...
              <Text fontSize="md" as="span">
                <Link as={NextLink} href={`/teams/view/${data?.player?.[0]?.team?.id}`}>
                  {data?.player?.[0]?.team?.name}
                </Link>
              </Text>
              <br />
            </>
